...
function M.create(palette, zitch_pattern, config)
	...
	local groups = {
		...
		NeoTreeDirectoryIcon = { bg = "NONE", fg = palette.orange },
		...
		NeoTreeCursorLine = { bg = config.transparent_bg and "NONE" or palette.charcoal },
		NeoTreeFloatBorder = { bg = config.transparent_bg and "NONE" or palette.darkblack, fg = palette.magenta },
