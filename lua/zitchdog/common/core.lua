...
function core.createPaletteByPattern(pattern)
	...
	elseif pattern == "zitchdog-pine" then
		...
		palette.black = normalizeHex("#0c080f")
		palette.magenta = normalizeHex("#834264")
		palette.yellow = normalizeHex("#e37832")
		palette.mauve = normalizeHex("#171118")
		palette.blue = normalizeHex("#658265")
		palette.charcoal = normalizeHex("#0b090e")
		palette.slate = normalizeHex("#2d1e26")
		palette.graphite = normalizeHex("#281f27")
	...
	elseif pattern == "zitchdog-grape" then
		...
		palette.black = normalizeHex("#0b080e")
		palette.magenta = normalizeHex("#8443e4")
		palette.yellow = normalizeHex("#e09066")
		palette.mauve = normalizeHex("#181025")
		palette.blue = normalizeHex("#64aae2")
		palette.charcoal = normalizeHex("#0f070e")
		palette.slate = normalizeHex("#2d1d44")
		palette.graphite = normalizeHex("#262042")
